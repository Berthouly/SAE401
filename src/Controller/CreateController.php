    ...
    public function index(EntityManagerInterface $entityManager, ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        array_push($wordlist25, array(
            ...
            'jetonsrestants' => 9
                ...
                if($locale == 'fr') {
                    $url = "http://mmi21g01.sae401.ovh/jeu/partiefr/$partieID/" . base64_encode($joueur); // ligne
                    ...
                    $url = "http://mmi21g01.sae401.ovh/jeu/partieen/$partieID/" . base64_encode($joueur); // ligne
